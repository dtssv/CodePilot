...
object ReadOnlyShellGuard {
    ...
    private val ALLOWED_PREFIXES = listOf(
        ...
        "file", "stat", "du", "df", "pwd", "echo", "printf", "env", "printenv",
        "uname", "hostname", "date", "id", "whoami",
        "node -v", "node --version", "npm -v", "npm --version", "npm ls",
        "npx --version", "yarn --version", "pnpm --version",
        "java -version", "java --version", "javac -version",
        "mvn -v", "mvn --version", "mvn dependency:tree", "mvn help:effective-pom",
        "gradle -v", "gradle --version", "gradle dependencies",
