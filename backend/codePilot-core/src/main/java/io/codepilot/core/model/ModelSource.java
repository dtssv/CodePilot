 ...
 *
 * <ul>
 *   <li>{@link #GROUP} — a system model group ({@code model_groups} table)
 *   <li>{@link #CUSTOM} — a user-level custom model ({@code custom_model_providers} table)
 * </ul>
 *
 * <p>This allows {@link ChatClientFactory#resolve(String, ModelSource)} to directly target the
 * correct resolution path instead of trying both tables.
 */
