...
/**
 * Admin service providing session, user, and model management operations.
 * Data sources: PostgreSQL (audit_events, model_groups, custom_model_providers)
...
public class AdminService {
     ...
     */
    public Map<String, Object> listSessions(int page, int size, String userId, String keyword,
        ...
        for (Map<String, Object> session : sessions) {
            ...
            try {
                var entries = redisTemplate.opsForHash()
                        .entries("codepilot:session:" + sessionId).collectList().block();
    ...
    public Map<String, Object> getSessionDetail(String sessionId) {
        ...
        List<Map<String, Object>> events = jdbc.queryForList(
                sql, new MapSqlParameterSource("sessionId", sessionId));
        ...
        String toolSql = """
            ...
            """;
        List<Map<String, Object>> toolStats = jdbc.queryForList(
                toolSql, new MapSqlParameterSource("sessionId", sessionId));
    ...
    public void deleteSession(String sessionId) {
        ...
        // Delete audit events
        jdbc.update("DELETE FROM audit_events WHERE session_id = :sessionId",
    ...
    public Map<String, Object> getSessionStats() {
        ...
        Long dau = jdbc.queryForObject(dauSql,
                new MapSqlParameterSource("since", today), Long.class);
    ...
    public Map<String, Object> getUserDetail(String userId) {
        ...
        List<Map<String, Object>> rows = jdbc.queryForList(
                sql, new MapSqlParameterSource("userId", userId));
        if (rows.isEmpty()) {
        ...
        String tokenSql = """
            ...
            """;
        Long toolCalls = jdbc.queryForObject(tokenSql,
    ...
    public Map<String, Object> getUserStats() {
        ...
        String mauSql = """
            ...
            WHERE created_at >= CAST(:since AS DATETIME)
            """;
        String monthStart = Instant.now()
                .truncatedTo(java.time.temporal.ChronoUnit.DAYS)
                .minus(Instant.now().atZone(java.time.ZoneOffset.UTC).getDayOfMonth() - 1,
                        java.time.temporal.ChronoUnit.DAYS)
                .toString();
        Long mau = jdbc.queryForObject(mauSql,
                new MapSqlParameterSource("since", monthStart), Long.class);
    ...
    public Map<String, Object> listModels(int page, int size) {
        ...
        String customSql = """
            ...
            """;
        List<Map<String, Object>> customRows = jdbc.queryForList(customSql, new MapSqlParameterSource());
    ...
    public Map<String, Object> getModelUsage(UUID id) {
        ...
        String usageSql = """
            ...
            """;
        Long callCount = jdbc.queryForObject(usageSql,
                new MapSqlParameterSource("modelName", modelName), Long.class);
    ...
    public Map<String, Object> getModelStats() {
        ...
        for (ModelGroup g : groups) {
            ...
            String usageSql = """
                ...
                """;
            Long callCount = jdbc.queryForObject(usageSql,
                    new MapSqlParameterSource("modelName", g.name()), Long.class);
