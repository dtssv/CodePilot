...
/**
 * Read-only projection of the model_app_keys table.
 * An app key is an individual API key under a model group,
 * used for load balancing across multiple keys.
 * The actual API key cipher is never exposed to the client.
 *
