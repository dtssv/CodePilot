 ...
 * (contexts.refs, pinned, taskLedger.notes, input). Plugins that already know the answer can carry
 * it via taskLedger.notes (e.g. "Java 17 + Spring Boot").
 */
@Component
public class WorkspaceProbe {
  ...
  private void mineNote(
      String note, Set<String> languages, Set<String> frameworks, Set<String> keywords) {
