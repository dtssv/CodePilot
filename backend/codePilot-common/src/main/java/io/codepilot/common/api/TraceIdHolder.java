 ...
 *
 * <p>The reactive adapter is wired in {@code GatewayTraceIdWebFilter}; the servlet fallback is in
 * {@code MdcTraceIdFilter}. Consumers access the value through {@link #current()}.
 */
