...
/**
 * Insert-only helper for the {@code system_leak_events} table. Callers MUST supply a short redacted
 * excerpt (<=200 chars); never pass raw prompt contents.
 */
@Repository
    ...
    var params =
        new MapSqlParameterSource()
            ...
            .addValue(
                ...
                sampleExcerpt == null
                    ? null
                    : sampleExcerpt.substring(0, Math.min(200, sampleExcerpt.length())));
