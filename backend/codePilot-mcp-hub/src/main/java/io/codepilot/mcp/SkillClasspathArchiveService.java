...
/**
 * Builds a minimal Skill ZIP ({@code skill.yaml} only) from {@code codePilot-core}
 * {@code skills/*.yaml} on the classpath. Used when marketplace rows ship without {@code download_url}.
 */
@Service
