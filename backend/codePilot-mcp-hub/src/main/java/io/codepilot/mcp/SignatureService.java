...
/**
 * Signature verification service for MCP/Skill packages. Verifies packages from the marketplace
 * have valid signatures (SHA256withRSA). The signature covers the package hash (sha256) + manifest
 * JSON.
 */
@Service
public class SignatureService {
  ...
  public boolean verifySignature(
      String sha256, String manifestJson, String signatureBase64, String publicKeyBase64) {
    try {
  ...
  /**
   * Verify an official marketplace package signature. Uses the platform's built-in public key from
   * configuration.
   */
  public boolean verifyOfficialSignature(
      String sha256, String manifestJson, String signatureBase64) {
