...
/**
 * Admin dashboard API for session, user, and model management. All endpoints require admin API key
 * authentication (via {@link AdminAuthFilter}).
 */
...
public class AdminController {
  ...
  public ApiResponse<Map<String, Object>> listSessions(
    ...
    return ApiResponse.ok(
        adminService.listSessions(page, size, userId, keyword, startTime, endTime));
  }
  ...
  public ApiResponse<Map<String, Boolean>> updateModelConfig(
      @PathVariable UUID id, @RequestBody UpdateModelConfigRequest req) {
