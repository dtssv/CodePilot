...
/**
 * Serves the Admin Dashboard SPA page at /admin.
 * The HTML/JS is bundled as a classpath resource (admin/index.html).
 * This controller reads it and returns it as HTML.
 */
@RestController
    ...
    public Mono<ResponseEntity<Flux<DataBuffer>>> adminPage() {
        return Mono.fromSupplier(() -> {
            try {
                ...
                DataBuffer buffer = new DefaultDataBufferFactory().wrap(
